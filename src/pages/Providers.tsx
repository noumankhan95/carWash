...
type ProvidersList = providerSetValue & {
  id: string;
    ...
    <div>
            ...
            <ul>
              <li
                ...
                onClick={async () => {
                  try {
                    setisdeleting(true);
                    await deleteDoc(doc(db, 'providers', todelete));
                    settodelete('');
        ...
        <table className="w-full table-auto ">
          <thead>
            <tr className="bg-gray-2 text-left dark:bg-meta-4">
              ...
              <th className="min-w-[120px] py-4 px-4 font-medium text-black dark:text-white"></th>
            </tr>
          </thead>
                  ...
                  <tr>
                    ...
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                      <p className="inline-flex rounded-full bg-success bg-opacity-10 py-1 px-3 text-sm font-medium text-success">
                        {u.providerInfo.arabicname}
                      </p>
                    </td>
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                      <p className="text-black dark:text-white">
                        {u.providerAccountInfo.email}
                      </p>
                    </td>
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                      <p className="text-black dark:text-white">
                        {u.providerAccountInfo.number}
                      </p>
                    </td>
                        ...
                        <button
                          ...
                          onClick={() => {
                            ...
                            setAllProviderInformation({
                              ...
                              providerAddressInfo: u.providerAddressInfo,
                              providerInfo: u.providerInfo,
                            });
                            setallsubscriptions(u.Subscriptions);
      ...
      {isloading && (
        <div className="mx-auto w-full">
          <LoaderIcon className="h-20 w-20 my-10  mx-auto" />
        </div>
      )}
      <button
        className="my-5 rounded-md inline-flex w-52 items-center justify-center bg-primary py-4 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10"
        onClick={() => {
          navigate('/editproviders');
        }}
      >
