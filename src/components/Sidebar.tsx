        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {permissions &&
                roles[permissions]?.some((e) => e.startsWith('Offers')) && (
                  <li>
                    <NavLink
                      to="/offers"
                      className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      ...
                      >
                        ...
                        <g id="SVGRepo_iconCarrier">
                          ...
                          <g>
                            ...
                            <g>
                              {' '}
                              <path d="M5.061,3.655c0-0.222,0.03-0.435,0.057-0.648C5.098,3.007,5.081,3,5.061,3c-1.656,0-3,1.636-3,3.655S3.405,11,5.061,11 C6.18,11,7.144,9.934,7.66,8.623C6.109,7.777,5.061,5.628,5.061,3.655z"></path>{' '}
                              <path d="M13.061,3c-0.02,0-0.037,0.007-0.057,0.007c0.027,0.213,0.057,0.426,0.057,0.648c0,1.973-1.049,4.122-2.6,4.968 c0.517,1.311,1.48,2.377,2.6,2.377c1.657,0,3-2.325,3-4.345S14.718,3,13.061,3z"></path>{' '}
                              <path d="M12.061,3.655c0,2.02-1.343,4.345-3,4.345c-1.656,0-3-2.325-3-4.345S7.405,0,9.061,0C10.718,0,12.061,1.635,12.061,3.655z "></path>{' '}
