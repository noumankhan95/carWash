        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item Profile --> */}
              {permissions &&
                permissions.some((e) => e.startsWith('Staff')) && (
                  <li>
                    <NavLink
                      to="/staff"
                      className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
              ...
              {permissions &&
                permissions.some((e) => e.startsWith('Roles')) && (
                  <li>
                    <NavLink
                      to="/roles"
                      className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
              ...
              {permissions &&
                permissions.some((e) => e.startsWith('Orders')) && (
                  <li>
                    <NavLink
                      to="/orders"
                      className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
              ...
              {permissions &&
                permissions.some((e) => e.startsWith('Subscriptions')) && (
                  <li>
                    <NavLink
                      to="/subscriptions"
                      className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
              ...
              {permissions &&
                permissions.some((e) => e.startsWith('Upsellings')) && (
                  <li>
                    <NavLink
                      to="/upsellings"
                      className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
